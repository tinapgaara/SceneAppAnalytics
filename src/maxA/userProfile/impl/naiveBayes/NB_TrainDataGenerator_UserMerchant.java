 ...
 */
public class NB_TrainDataGenerator_UserMerchant extends GenericTrainDataGenerator_UserMerchant {

    private static NB_TrainDataGenerator_UserMerchant m_instance = null;

    protected static int mGeneratedTrainDataNum;

    public static NB_TrainDataGenerator_UserMerchant getInstance() {

        if (m_instance == null) {
            m_instance = new NB_TrainDataGenerator_UserMerchant();
        }
        return m_instance;
    }

    private NB_TrainDataGenerator_UserMerchant() {
    ...
    protected GenericTrainData_UserMerchant createTrainData_UserMerchant(JavaRDD<LabeledPoint> rdd) {
        return new NB_TrainData_UserMerchant(rdd);
    }
