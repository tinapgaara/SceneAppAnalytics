 ...
 */
public class SVM_OnlineDataGenerator_UserUser extends GenericOnlineDataGenerator_UserUser {

    private static SVM_OnlineDataGenerator_UserUser m_instance = null;

    public static SVM_OnlineDataGenerator_UserUser getInstance() {

        if (m_instance == null) {
            m_instance = new SVM_OnlineDataGenerator_UserUser();
        }
        return m_instance;
    }

    private SVM_OnlineDataGenerator_UserUser() {
        // nothing to do here
    }
