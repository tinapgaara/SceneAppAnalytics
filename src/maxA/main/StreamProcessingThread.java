...
public class StreamProcessingThread extends Thread implements Serializable {
    ...
    // TODO: For different test case, can be deleted in future when AppLog format has been corrected.
    private static int mTestCase;
    ...
    public void run() {
        ...
        while ( (numRecords2Process > 0) || (! shouldStop()) ) {
            try {
                ...
                if (nextRecord == null) {
                    ...
                    // present only because we don't have training data
